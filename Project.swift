    ...
    targets: [
        .target(
            ...
            infoPlist: .extendingDefault(with: [
                ...
                "CFBundleVersion": "9",
                "NSAppleEventsUsageDescription": "PathBridge needs Automation permission to read Finder's current folder and control your selected terminal.",
            ]),
        ...
        .target(
            ...
            infoPlist: .extendingDefault(with: [
                ...
                "CFBundleVersion": "9",
                "LSUIElement": true,
                "NSAppleEventsUsageDescription": "PathBridge Launcher needs Automation permission to read Finder's current folder and control your selected terminal.",
            ]),
